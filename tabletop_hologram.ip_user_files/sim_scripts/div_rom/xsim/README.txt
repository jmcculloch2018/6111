...
#
# Generated by export_simulation on Mon Nov 18 15:13:57 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './div_rom.sh' script.

./div_rom.sh -reset_run
...
./div_rom.sh -noclean_files

For more information on the script, please type './div_rom.sh -help'.
