...
#
# Generated by export_simulation on Sat Dec 07 19:57:59 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './demo_rom3.sh' script.

./demo_rom3.sh -reset_run
...
./demo_rom3.sh -noclean_files

For more information on the script, please type './demo_rom3.sh -help'.
