...
#
# Generated by export_simulation on Fri Dec 06 15:40:17 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './banana_rom1.sh' script.

./banana_rom1.sh -reset_run
...
./banana_rom1.sh -noclean_files

For more information on the script, please type './banana_rom1.sh -help'.
