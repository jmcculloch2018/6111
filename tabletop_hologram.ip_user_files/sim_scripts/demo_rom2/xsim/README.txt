...
#
# Generated by export_simulation on Fri Dec 06 17:54:30 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './demo_rom2.sh' script.

./demo_rom2.sh -reset_run
...
./demo_rom2.sh -noclean_files

For more information on the script, please type './demo_rom2.sh -help'.
