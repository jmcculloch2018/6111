...
#
# Generated by export_simulation on Fri Nov 15 13:59:54 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './projection_divider.sh' script.

./projection_divider.sh -reset_run
...
./projection_divider.sh -noclean_files

For more information on the script, please type './projection_divider.sh -help'.
