...
#
# Generated by export_simulation on Wed Jan 15 16:55:27 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './projection_sqrt.sh' script.

./projection_sqrt.sh -reset_run
...
./projection_sqrt.sh -noclean_files

For more information on the script, please type './projection_sqrt.sh -help'.
