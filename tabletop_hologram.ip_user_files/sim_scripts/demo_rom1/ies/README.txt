...
#
# Generated by export_simulation on Sat Dec 07 19:52:24 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './demo_rom1.sh' script.

./demo_rom1.sh -reset_run
...
./demo_rom1.sh -noclean_files

For more information on the script, please type './demo_rom1.sh -help'.
