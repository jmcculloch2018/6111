...
#
# Generated by export_simulation on Sun Dec 08 16:29:06 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './banana_rom2.sh' script.

./banana_rom2.sh -reset_run
...
./banana_rom2.sh -noclean_files

For more information on the script, please type './banana_rom2.sh -help'.
