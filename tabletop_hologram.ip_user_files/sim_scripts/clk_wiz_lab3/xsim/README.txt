...
#
# Generated by export_simulation on Mon Nov 25 13:25:50 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_lab3.sh' script.

./clk_wiz_lab3.sh -reset_run
...
./clk_wiz_lab3.sh -noclean_files

For more information on the script, please type './clk_wiz_lab3.sh -help'.
