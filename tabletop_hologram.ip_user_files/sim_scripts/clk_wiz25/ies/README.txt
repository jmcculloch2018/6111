...
#
# Generated by export_simulation on Fri Dec 06 09:18:26 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './clk_wiz25.sh' script.

./clk_wiz25.sh -reset_run
...
./clk_wiz25.sh -noclean_files

For more information on the script, please type './clk_wiz25.sh -help'.
