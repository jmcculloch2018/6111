...
#
# Generated by export_simulation on Tue Nov 12 17:43:56 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './triangles_rom.sh' script.

./triangles_rom.sh -reset_run
...
./triangles_rom.sh -noclean_files

For more information on the script, please type './triangles_rom.sh -help'.
