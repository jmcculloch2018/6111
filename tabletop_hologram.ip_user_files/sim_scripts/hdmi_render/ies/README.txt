...
#
# Generated by export_simulation on Sat Nov 16 02:01:38 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './hdmi_render.sh' script.

./hdmi_render.sh -reset_run
...
./hdmi_render.sh -noclean_files

For more information on the script, please type './hdmi_render.sh -help'.
